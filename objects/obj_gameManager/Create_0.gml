...
3. Background art in fullscreen - DONE.
4. Handle keyboard and controller inputs - DONE
*/
...
for (var _i = 1; GAME_WIDTH * _i < _display_width && GAME_HEIGHT * _i < _display_height; ++_i) {
