...
//When on an encounter animation, show the sign on the player using the index defined previously, this index can be changed as the game sets the index.
...
//Draw itself as long as you're not in the battle state.
