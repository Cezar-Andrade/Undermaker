...
can_collide = true;
can_open_menu = true;
state = 0; //CURRENTLY NOT IN USE //The player is moving in the state 0, any other number makes the player do nothing, perfect for controlling separatedlly animations or any other thing, make sure to call player_anim_reset() so the player doesn't look like it's in the middle of a walk in the trigger event objects and interactions.
