...
interaction = function(){
	...
	var _sprite_change = function(){
		inst_scary_kris_dog.can_player_collide = false;
		inst_scary_kris_dog.sprite_index = spr_hotdiggitydemondotcom;
	}
	
	var _sprite_unchange = function(){
		inst_scary_kris_dog.can_player_collide = true;
		inst_scary_kris_dog.sprite_index = spr_kris_dog;
	}
