interaction = function(){
	...
	create_choice_option("left", 120, 390, "Yes?", _yes_dialog);
	create_choice_option("right", 430, 390, "No?", _no_dialog);
	create_choice_option("up", 260, 350, "Maybe?", _maybe_dialog);
	create_choice_option("down", 220, 430, "I don't know.", _idk_dialog);
	
	overworld_dialog(["Are you a dialog test?[w:20]\nI will give you more options than the jerk on the left.","[progress_mode:none][asterisk:false][func:" + string(start_choice) + ", 320, 390]"], false);
